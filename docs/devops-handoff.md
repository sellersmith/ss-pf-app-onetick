...
`sellersmith/ss-pf-app-onetick`

## Goal

Publish OneTick app-platform artifacts independently from PageFly Core/Server builds.
...
publish GitHub Release assets on onetick-v* tags
```
...
```json
{
  "onetick": {
    ...
    "url": "https://github.com/sellersmith/ss-pf-app-onetick/releases/download/onetick-v0.1.0-beta.12/ss-pf-app-onetick-0.1.0-beta.12.tgz",
    "sha256": "<sha256>"
  }
}
```
...
No OneTick rebuild is required.
